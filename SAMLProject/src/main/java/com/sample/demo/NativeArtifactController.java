...
@Controller
public class NativeArtifactController {
	...
	public RedirectView artifact(@RequestParam("SAMLart") String SAMLart, @RequestParam("RelayState") String RelayState) {
		...
		try {
			...
			redirectView.setUrl("https://localhost:8443/native/response?SAMLResponse=" + encodedResponseString);
